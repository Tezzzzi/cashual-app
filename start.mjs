...
async function runAdditiveMigrations() {
  ...
  try {
    ...
    const additiveColumns = [
      ...
      ['users', 'customDisplayName', 'ALTER TABLE `users` ADD `customDisplayName` varchar(128) DEFAULT NULL'],
      ['users', 'customAvatarUrl', 'ALTER TABLE `users` ADD `customAvatarUrl` text'],
